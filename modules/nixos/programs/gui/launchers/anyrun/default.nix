{
  ...
  inherit (lib) mkIf;
  inherit (lib.${namespace}) mkBoolOpt compileSCSS;

  cfg = config.${namespace}.programs.gui.anyrun;
in {
  options.${namespace}.programs.gui.anyrun = {
    enable = mkBoolOpt false "Whether or not to enable anyrun.";
  };
