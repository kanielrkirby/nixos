...
with lib;
{
  options.gearshift.starship.enable = mkEnableOption "FZF";

  config = mkIf config.gearshift.starship.enable {
    home-manager.users."${config.gearshift.username}" = {
      programs.starship.enableZshIntegration = config.home-manager.users."${config.gearshift.username}".programs.zsh.enable;
